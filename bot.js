...
const developers = ['454724311194927114'];
const admin = ".";
const prefix = ".";
...
client.on('ready', () => {
  ...
  console.log('By : '+`${client.users.get("454724311194927114").username}`)
   client.user.setActivity("Vade | .help",{type: 'WATCHING'})
...
client.on('message', message => {
  ...
  if (message.content.startsWith(admin + 'setstream')) {
    client.user.setGame(argresult, "https://www.twitch.tv/immohamed_x");
